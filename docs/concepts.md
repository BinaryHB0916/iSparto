...
| **Compliance Audit** | The post-session review performed by Process Observer during /end-working. Checks 5 categories (branch convention, Codex review compliance, Doc Engineer compliance, PR workflow, ownership violations) across 13 items. Outputs a deviation report with PASS/FAIL/WARNING status. | Similar to a SOX compliance audit, but for development workflow |
