...
- **事后审计（Sub-agent）**：/end-working 流程中，在 Doc Engineer 之后运行，对照 5 个 Checklist（共 14 个检查项：A1-A3 分支规范、B1-B4 Codex Review 合规、C1-C4 Doc Engineer 合规、D1-D2 PR 流程合规、E1-E2 越权操作）输出偏差报告
