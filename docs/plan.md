...
| FR-39 | A-layer Peer Review 整套机制铲除（用户 direction） | 删 `docs/design-principles/a-layer-peer-review.md` + 清理 7 处 cross-reference (CLAUDE.md / CLAUDE-TEMPLATE.md / agents/independent-reviewer.md / docs/concepts.md / commands/plan.md / docs/design-decisions.md / information-layering-policy.md) | high | 2026-04-27 user direction |
